...
const hobbits = ref<string[]>(['一週兩次以上', '一週一次', '無']);
const hobbitsvalue = ref<string>('');
const location = ref<string[]>(['台中市中區',
  '台中市東區',
  '台中市西區',
  '台中市南區',
  '台中市北區',
...
const suject = ref<string[]>(['一對一健身私人教練課 諮詢體驗(60分鐘) $600', '完整填妥表格，我們將由專人處理 並會在24H內回覆您並確認訂課，請您耐心等待']);
const sujectvalue = ref<string>('');
// 資料 --------------------------------------------------------------------------------------------
